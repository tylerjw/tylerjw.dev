...
#[test]
fn test_sextant_chart_command_json_output() -> anyhow::Result<()> {
...
#[test]
fn test_sextant_chart_command_yaml_output() -> anyhow::Result<()> {
    let temp_dir = TempDir::new()?;
    let chart_dir = create_test_chart(&temp_dir, "test-chart")?;
...
#[test]
fn test_sextant_chart_command_with_output_file() -> anyhow::Result<()> {
    let temp_dir = TempDir::new()?;
    let chart_dir = create_test_chart(&temp_dir, "test-chart")?;
...
#[test]
fn test_sextant_charts_command() -> anyhow::Result<()> {
    let temp_dir = TempDir::new()?;
...
#[test]
fn test_sextant_charts_command_with_summary() -> anyhow::Result<()> {
    let temp_dir = TempDir::new()?;
...
#[test]
fn test_sextant_charts_command_with_output_dir() -> anyhow::Result<()> {
    let temp_dir = TempDir::new()?;
...
#[test]
fn test_sextant_invalid_format() -> anyhow::Result<()> {
    let temp_dir = TempDir::new()?;
    let chart_dir = create_test_chart(&temp_dir, "test-chart")?;

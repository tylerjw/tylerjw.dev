...
#[test]
fn test_sextant_chart_command_json_output() -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn test_sextant_chart_command_yaml_output() -> Result<(), Box<dyn std::error::Error>> {
    let temp_dir = TempDir::new()?;
    let chart_dir = create_test_chart(&temp_dir, "test-chart")?;
...
#[test]
fn test_sextant_chart_command_with_output_file() -> Result<(), Box<dyn std::error::Error>> {
    let temp_dir = TempDir::new()?;
    let chart_dir = create_test_chart(&temp_dir, "test-chart")?;
...
#[test]
fn test_sextant_charts_command() -> Result<(), Box<dyn std::error::Error>> {
    let temp_dir = TempDir::new()?;
...
#[test]
fn test_sextant_charts_command_with_summary() -> Result<(), Box<dyn std::error::Error>> {
    let temp_dir = TempDir::new()?;
...
#[test]
fn test_sextant_charts_command_with_output_dir() -> Result<(), Box<dyn std::error::Error>> {
    let temp_dir = TempDir::new()?;
...
fn test_sextant_invalid_chart_directory() {
    ...
    assert!(stderr.contains("No Chart.yaml or Chart.yml found"));
}

#[test]
fn test_sextant_invalid_format() -> Result<(), Box<dyn std::error::Error>> {
    let temp_dir = TempDir::new()?;
    let chart_dir = create_test_chart(&temp_dir, "test-chart")?;
